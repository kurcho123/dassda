...
Citizen.CreateThread(function()
	AddTextEntry("ParaTattoos", "Студио за татуировки")
...
function RemoveTattoo(name, label)
	...
	QBCore.Functions.Notify("You have removed the " .. GetLabelText(label) .. " tattoo", "success", 4000)
end
