...
QBConfig.MaxPlayers = GetConvarInt('sv_maxclients', 959) -- Gets max players from config file, default 48
...
QBConfig.Money = {}
QBConfig.Money.MoneyTypes = { ['cash'] = 1000, ['bank'] = 5000, ['crypto'] = 0 } -- ['type']=startamount - Add or remove money types for your server (for ex. ['blackmoney']=0), remember once added it will not be removed from the database!
QBConfig.Money.DontAllowMinus = { 'cash', 'crypto' } -- Money that is not allowed going in minus
QBConfig.Money.PayCheckTimeOut = 45 -- The time in minutes that it will give the paycheck
...
QBConfig.Player = {}
QBConfig.Player.MaxWeight = 135000 -- Max weight a player can carry (currently 120kg, written in grams)
