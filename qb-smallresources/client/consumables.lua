...
function JointEffect()
    -- if not onWeed then
    --     local RelieveOdd = math.random(15, 25)
    --     onWeed = true
...
RegisterNetEvent("consumables:client:Fries", function(itemName)
    ...
    QBCore.Functions.Progressbar("eat_something", "Ядене...", 5000, false, true, {
...
RegisterNetEvent('catcaffe-galene', function(itemName)
    TriggerEvent('animations:client:EmoteCommandStart', {"petting"})
    QBCore.Functions.Progressbar("eat_something", "Галиш котето любовно... ;p", 5000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
...
RegisterNetEvent("consumables:client:DrinkSoda", function(itemName)
    ...
    QBCore.Functions.Progressbar("drink_something", "Пиене...", 5000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
...
RegisterNetEvent("consumables:client:DrinkCoffee", function(itemName)
    ...
    QBCore.Functions.Progressbar("drink_something", "Пия кафе...", 5000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
...
RegisterNetEvent('consumables:client:Eat', function(itemName)
    ...
    QBCore.Functions.Progressbar("eat_something", "Хапваш..", 5000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
...
RegisterNetEvent('consumables:client:Drink', function(itemName)
    ...
    QBCore.Functions.Progressbar("drink_something", "Пиеш..", 5000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
