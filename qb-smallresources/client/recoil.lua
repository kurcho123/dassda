local recoils = {
	...
	-- Handguns
	[453432689] = 0.001,			--['weapon_pistol']
	[-1075685676] = 0.01,		--['weapon_pistol_mk2']
	[1593441988] = 0.01,			--['weapon_combatpistol']
	[584646201] = 0.0001,			--['weapon_appistol']
	[911657153] = 0.01,			--['weapon_stungun']
	[-1716589765] = 0.01,		--['weapon_pistol50']
	[-1076751822] = 0.01,		--['weapon_snspistol']
	[-771403250] = 0.01,			--['weapon_heavypistol']
	[137902532] = 0.01,			--['weapon_vintagepistol']
	[1198879012] = 0.01,			--['weapon_flaregun']
	[-598887786] = 0.01,			--['weapon_marksmanpistol']
	[-1045183535] = 0.01,		--['weapon_revolver']
	[-879347409] = 0.01,			--['weapon_revolver_mk2']
	[-1746263880] = 0.01,		--['weapon_doubleaction']
	[-2009644972] = 0.01,		--['weapon_snspistol_mk2']
	[-1355376991] = 0.01,		--['weapon_raypistol']
	[727643628] = 0.01,			--['weapon_ceramicpistol']
	[-1853920116] = 0.01,		--['weapon_navyrevolver']
	[1470379660] = 0.01,			--['weapon_gadgetpistol']

	-- Submachine Guns
	[324215364] = 0.01,			--['weapon_microsmg']
	[736523883] = 0.01,			--['weapon_smg']
	[2024373456] = 0.01,			--['weapon_smg_mk2']
	[-270015777] = 0.01,			--['weapon_assaultsmg']
	[171789620] = 0.01,			--['weapon_combatpdw']
	[-619010992] = 0.01,			--['weapon_machinepistol']
	[-1121678507] = 0.01,		--['weapon_minismg']
	[1198256469] = 0.01,			--['weapon_raycarbine']

	-- Shotguns
	[487013001] = 0.01,			--['weapon_pumpshotgun']
	[2017895192] = 0.01,			--['weapon_sawnoffshotgun']
	[-494615257] = 0.01,			--['weapon_assaultshotgun']
	[-1654528753] = 0.01,		--['weapon_bullpupshotgun']
	[-1466123874] = 0.01,		--['weapon_musket']
	[984333226] = 0.01,			--['weapon_heavyshotgun']
	[-275439685] = 0.01,			--['weapon_dbshotgun']
	[317205821] = 0.01,			--['weapon_autoshotgun']
	[1432025498] = 0.01,			--['weapon_pumpshotgun_mk2']
	[94989220] = 0.0,			--['weapon_combatshotgun']

	-- Assault Rifles
	[-1074790547] = 0.05,		--['weapon_assaultrifle']
	[961495388] = 0.02,			--['weapon_assaultrifle_mk2']
	[-2084633992] = 0.03,		--['weapon_carbinerifle']
	[-86904375] = 0.01,			--['weapon_carbinerifle_mk2']
	[-1357824103] = 0.01,		--['weapon_advancedrifle']
	[-1063057011] = 0.02,		--['weapon_specialcarbine']
	[2132975508] = 0.02,			--['weapon_bullpuprifle']
	[1649403952] = 0.03,			--['weapon_compactrifle']
	[-1768145561] = 0.02,		--['weapon_specialcarbine_mk2']
	[-2066285827] = 0.02,		--['weapon_bullpuprifle_mk2']
