...
RegisterNetEvent("Dob4oo:openGangStash")
AddEventHandler("Dob4oo:openGangStash", function()
    TriggerServerEvent("inventory:server:OpenInventory", "stash", "boss_" .. PlayerGang.name, {
        maxweight = 8500000,
        slots = 200,
    })
...
RegisterNetEvent("Dob4oo:openGangClothing")
AddEventHandler("Dob4oo:openGangClothing", function()
    TriggerEvent("qb-clothing:client:openOutfitMenu")
end) 

RegisterNetEvent("Floki:openGangStash")
AddEventHandler("Floki:openGangStash", function()
    TriggerServerEvent("inventory:server:OpenInventory", "stash", "boss_" .. PlayerGang.name, {
        maxweight = 8500000,
        slots = 200,
    })
...
RegisterNetEvent("Floki:openGangClothing")
AddEventHandler("Floki:openGangClothing", function()
    TriggerEvent("qb-clothing:client:openOutfitMenu")
end) 
