...
RegisterNetEvent('CL-Pizzeria:OpenShop', function()
	QBCore.Functions.TriggerCallback('CL-Pizzeria:CheckDuty', function(result)
		if result then
			TriggerServerEvent("inventory:server:OpenInventory", "shop", "Магазин", Config.ShopItems)
		else
...
RegisterNetEvent('CL-Pizzeria:OpenAddonsShop', function()
	QBCore.Functions.TriggerCallback('CL-Pizzeria:CheckDuty', function(result)
		if result then
			TriggerServerEvent("inventory:server:OpenInventory", "shop", "Добавка за пица", Config.PizzaExtrasItems)
		else
			QBCore.Functions.Notify(Config.Locals["Notifications"]["MustBeOnDuty"], "error")
		end
	end)
...
RegisterNetEvent("CL-Pizzeria:CookPizzaMenu", function()
	QBCore.Functions.TriggerCallback('CL-Pizzeria:CheckDuty', function(result)
        if result then
			...
			CookPizzaMenu[#CookPizzaMenu+1] = {
				header = "<img src=https://cdn.discordapp.com/attachments/970346069378613268/1026843124133265510/pfishburger.png width=30px> ".." ┇ Cook Fish Burger",
				txt = "Ingredients: <br> - Cheddar Cheese <br> - Seafood Mix <br> - Parmesan Cheese <br> - Pork Meat <br> - Basil",
				params = {
					event = "CL-Pizzeria:Make",
					args = {
						eventname = "FishBurger",
						number = 1,
						time = 8000,
						item2 = "pseafoodmix",
						item3 = "pcheddarcheese",
						item4 = "pbasil",
						item5 = "pparmesancheese",
						item6 = "pporkmeat",
						itemname = "Fish Burger",
						recieveitem = "pfishburger",
						animdict = "anim@amb@business@meth@meth_monitoring_no_work@",
						anim = "base_lazycook",
					}            
				}
			...
			CookPizzaMenu[#CookPizzaMenu+1] = {
				header = "<img src=https://cdn.discordapp.com/attachments/970346069378613268/1026842239567138956/pvegburger.png width=30px> ".." ┇ Cook Veg Burger",
				txt = "Ingredients: <br> - Tomatoes <br> - Vegi Cheese <br> - Basil <br> - Butter <br> - Mushrooms",
				params = {
					event = "CL-Pizzeria:Make",
					args = {
						eventname = "VegBurger",
