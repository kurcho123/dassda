...
Config.MinimalDoctors = 7
Config.WipeInventoryOnRespawn = true

Config.Locations = {
    ["checking"] = {
	    [1] = vector3(308.52, -592.55, 43.28), -- paleto
    },
    ["duty"] = {
        [1] = vector3(306.51, -601.21, 43.28),
    },
    ["vehicle"] = {
        [1] = vector4(293.03, -574.33, 43.2, 60.18),
    },
    ["helicopter"] = {
        [1] = vector4(351.41, -587.92, 74.17, 63.84),
    },
    ["armory"] = {
        [1] = vector3(304.23, -600.41, 43.28),
    },
    ["roof"] = {
        [1] = vector4(332.12, -595.63, 43.28, 250.38),
    },
    ["main"] = {
        [1] = vector3(339.15, -584.03, 74.17),
    },
    ["stash"] = {
        [1] = vector3(310.85, -597.15, 43.28),
    },
    ["beds"] = {
...
Config.AuthorizedVehicles = {
	...
	[0] = {
		["asprinter"] = "Спринтер",
		["ambulance"] = "Голяма линейка",	
        ["emsnspeedo"] = "Хубава линейка",	
	},
	-- Grade 1
	[1] = {
		["asprinter"] = "Спринтер",
