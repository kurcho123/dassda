...
vehicleBaseRepairCost = 500
vehicleRepairCostMultiplier = 100

-- ADJUST PRICING
vehicleCustomisationPrices = {
    cosmetics = {price = 1000},
    respray = {price = 1500},
    performance = {prices = {2000, 3000, 5000, 8000, 10000, 15000, 19000}},
    turbo = {prices = {10000, 20000}},
    wheels = {price = 1500},
    customwheels = {price = 100},
    wheelsmoke = {price = 100},
    windowtint = {price = 100},
    neonside = {price = 100},
    neoncolours = {price = 100},
    headlights = {price = 1000},
    xenoncolours = {price = 100},
    oldlivery = {price = 100},
...
vehicleWheelOptions = {
    ...
    {category = "RacerWheels", id = 13, wheelID = 23}
}
