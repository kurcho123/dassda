...
function setupLocations(locations, myHouses) {
    ...
    $(parent).append('<div class="loclabel" id="location" data-location="null" data-type="lab" data-label="Започваме!"><p><span id="null">Започваме!</span></p></div>')
    
    setTimeout(function(){
        $(parent).append('<div class="location" id="location" data-location="current" data-type="current" data-label="Последна Локация"><p><span id="current-location">Последна Локация</span></p></div>');
...
function setupApps(apps) {
    ...
    $(parent).append('<div class="loclabel" id="location" data-location="null" data-type="lab" data-label="Избери апартамент"><p><span id="null">Изберете апартамент</span></p></div>')
