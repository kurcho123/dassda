...
Config.MaximumTime = 12

Config.Rewards = {
    [1] = {
        ["cabin"] = {"plastic", "diamond_ring", "goldchain", "weed_skunk", "cryptostick"},
        ["kitchen"] = {"tosti", "sandwich", "nitrous", "lockpick", "cleaningkit", "thermite", "goldchain"},
        ["chest"] = {"plastic", "rolex", "diamond_ring", "goldchain", "weed_skunk", "cryptostick"},
        ["livingroom"] = {"plastic", "rolex", "diamond_ring", "goldchain", "thermite", "cryptostick", "tablet", "trojan_usb", "pistol_ammo"}
    }
}
