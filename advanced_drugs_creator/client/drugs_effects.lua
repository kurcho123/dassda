...
allEffects.pink_visual = function(duration)
    ...
    if(not activeEffects[effectName]) then
        ...
        while timer <= activeEffects[effectName] do
        ...
        activeEffects[effectName] = activeEffects[effectName] + duration
    end
end
...
allEffects.sprint_faster = function(duration)
...
allEffects.swim_faster = function(duration)
...
allEffects.fall = function(duration)
...
allEffects.infinite_stamina = function(duration)
