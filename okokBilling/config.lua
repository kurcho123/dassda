...
Config.InvoicesCommand = 'billing' -- Command used to open the invoices menu

Config.VATPercentage = 10 -- Visual only, it won't influence the final invoice value, change it to your country VAT value
...
Config.FeeAfterEachDayPercentage = 10 -- If Config.FeeAfterEachDay is enabled, it is used to set the fee percentage after each day
...
Config.BotName = 'FameOrShame RolePlay' -- Write the desired bot name

Config.ServerName = 'FameOrShame RolePlay' -- Write your server's name

Config.IconURL = 'https://cdn.discordapp.com/attachments/771074701640073256/956230771562123275/myLogo.png' -- Insert your desired image link
