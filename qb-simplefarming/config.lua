...
FoodProcessor = {
    ...
    BlipLabel = "Направи храна",                       -- Blip Label
...
DairyProcessor = {
    ...
    SetBlipScale = 0.65,
    SetBlipColour = 32,
    BlipLabel = "Направи млечни продукти",
    minZ = 32.05,
    maxZ = 35.00,
}
Seller = {
...
Config.ProcessingTime = {
    ["apple_processingtime"] = 15000,                    -- MS = Seconds (5000 ms = 5 seconds)
    ["beef_processingtime"] = 20000,
    ["bacon_processingtime"] = 20000,
    ["ham_processingtime"] = 20000,
    ["pork_processingtime"] = 20000,
    ["sausage_processingtime"] = 20000,
    ["milk_tradingtime"] = 17500,
    ["pumpkin_smashingtime"] = 17500,
    ["grape_processingtime"] = 17500,
    ["chillypepper_processingtime"] = 17500,
    ["tomatoes_processingtime"] = 17500,
}
...
Config.Sell = {
    ["apple"] = {
        ["price"] = math.random(2, 3)                  -- Seller Price
    },
    ["apple_juice"] = {
