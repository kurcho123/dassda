...
Config = {
    ...
    MenuKeybind = 'u', -- Get the button string here https://docs.fivem.net/docs/game-references/input-mapper-parameter-ids/keyboard/
    ...
    MenuImage = "https://i.imgur.com/kgzvDwQ.png", ----[Custom banner IMGUR or GIPHY URLs go here ]---
    ...
    MenuTitle = "FameOrShame",
    -- You can change the menu position here
    MenuPosition = "right", -- (left, right)
    -- You can enable or disable the Ragdoll keybinding here.
    RagdollEnabled = true,
    RagdollKeybind = 'EQUALS', -- Get the button string here https://docs.fivem.net/docs/game-references/input-mapper-parameter-ids/keyboard/
