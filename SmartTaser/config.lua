main = {
    ...
    safetyDefault = false,
    soundVolume = 1.0, -- This allows you to change the sound volume. The number should be a maximum of 1.0
    rangeToRemoveBarbs = 25.0, -- This is the range of barbs, after this, they will remove automatically
    arcModeRange = 1.0, -- This is the range your drive stun (arc) mode will operate in, you must be this close to another player
    driveStunCooldown = 2, -- This is the cooldown after using drive stun (arc) mode, before being able to use it again
    cartridgeReactivationCooldown = 2, -- This is the cooldown between reactivations
